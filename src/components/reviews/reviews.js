      ...
      <TransitionGroup>
        {reviews.map((id) => (
          <CSSTransition
            ...
            timeout={500}
            classNames={{
              enterActive: styles['reviews-animation-enter'],
              enterDone: styles['reviews-animation-enter-active'],
              exitActive: styles['reviews-animation-exit'],
              exitDone: styles['reviews-animation-exit-active'],
            }}
          >
            <Review id={id} />
          </CSSTransition>
